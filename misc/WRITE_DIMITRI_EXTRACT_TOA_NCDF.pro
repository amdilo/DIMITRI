...
; CREATE THE RESULTS VARIABLES
  ...
  VID_CS = NCDF_VARDEF(NCID, DIM_NCDF.VAR_CLOUD_TITLE, DIMPROD, /FLOAT)
  NCDF_ATTPUT, NCID, VID_CS, DIM_NCDF.UNITS, DIM_NCDF.UNITS_DL
  NCDF_ATTPUT, NCID, VID_CS, DIM_NCDF.LONG_NAME, DIM_NCDF.VAR_CLOUD_LONG
...
; WRITE DATA TO THE DEFINED VARIABLES
  ...
  NCDF_VARPUT, NCID, VID_CS, NCDF_OUTDATA.VAR_CLOUD[IDX]
