...
FUNCTION INGEST_AATSR_PRODUCT,IFILES,INPUT_FOLDER=INPUT_FOLDER,ICOORDS=ICOORDS,$
 ...
 ;
 ; :Params:
 ;      IFILES : in, required, type=string or string array
 ;        a string or string array of the full path filenames of products for ingestion.
 ;
 ; :Keywords:
 ;      INPUT_FOLDER:  
 ;        a string containing the full path of the 'input' folder, if not provided then it is derived from the filename
 ;
 ;      ICOORDS:            
 ;        a four element floating-point array containing the north, south, east and west coordinates of the roi, e.g [50.,45.,10.,0.]
 ;
 ;      NB_PIX_THRESHOLD:   
