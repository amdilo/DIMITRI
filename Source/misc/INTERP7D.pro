...
;*
;* PURPOSE:
;*      FUNCTION TO PERFORM 7D INTERPOLATION THROUGH A 7-D LOOK-UP TABLE (DIRECT DATA RANGE RESTRICTION METHOD)
;*
;* CALLING SEQUENCE:
;*      OUT_VAL = INTERP7D(DIM1_LUT, DIM2_LUT, DIM3_LUT, DIM4_LUT, DIM5_LUT, DIM6_LUT, OUT_LUT, $
...
;*      DIM6_LUT             : LOOK-UP TABLE 6TH DIMENSION
;*      DIM7_LUT             : LOOK-UP TABLE 7TH DIMENSION
;*      OUT_LUT              : OUTPUT DIMENSION OF THE 7-D LOOK-UP TABLE
...
;*      DIM7                 : INPUT 7TH DIMENSION DATA VALUES
;*      DIM1_BKPT_VALUES     : LUT_7D 1ST DIMENSION BREAKPOINT VALUES
;*      DIM2_BKPT_VALUES     : LUT_7D 2ND DIMENSION BREAKPOINT VALUES
;*      DIM3_BKPT_VALUES     : LUT_7D 3RD DIMENSION BREAKPOINT VALUES
;*      DIM4_BKPT_VALUES     : LUT_7D 4TH DIMENSION BREAKPOINT VALUES
;*      DIM5_BKPT_VALUES     : LUT_7D 5TH DIMENSION BREAKPOINT VALUES
;*      DIM6_BKPT_VALUES     : LUT_7D 6TH DIMENSION BREAKPOINT VALUES
;*      DIM7_BKPT_VALUES     : LUT_7D 7TH DIMENSION BREAKPOINT VALUES
;*
;* KEYWORDS:
...
FUNCTION INTERP7D, DIM1_LUT, DIM2_LUT, DIM3_LUT, DIM4_LUT, DIM5_LUT, DIM6_LUT, DIM7_LUT, OUT_LUT, $
                    DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, DIM7, DIM1_BKPT_VALUES, DIM2_BKPT_VALUES, $
                    DIM3_BKPT_VALUES, DIM4_BKPT_VALUES, DIM5_BKPT_VALUES, DIM6_BKPT_VALUES, DIM7_BKPT_VALUES, $
					INVERSE_Z=INVERSE_Z
  ...
  DIM6_DOINTERP = QUANTIZE_BOL_TOL(DIM6, DIM6_BKPT_VALUES, VAL_BOL=DIM6_VAL_BOL, VAL_TOL=DIM6_VAL_TOL)
  DIM7_DOINTERP = QUANTIZE_BOL_TOL(DIM7, DIM7_BKPT_VALUES, VAL_BOL=DIM7_VAL_BOL, VAL_TOL=DIM7_VAL_TOL)
  
  ; LOOP OVER INPUT DATA (DIM1,DIM2,DIM3,DIM4,DIM5,DIM6,DIM7) 
  FOR INC=0,NB_VAL-1 DO BEGIN
    ...
    DIM6_LUT_RNG_DIM1_BOL = DIM6_LUT(INDX_DIM1_LUT_BOL)
    DIM7_LUT_RNG_DIM1_BOL = DIM7_LUT(INDX_DIM1_LUT_BOL)	
    ...
    IF DIM1_DOINTERP(INC) EQ 0 THEN BEGIN
      ...
      IF KEYWORD_SET(INVERSE_Z) THEN BEGIN
          ; IN CASE OF LUT INVERSION LAST DIMENSION (DIM7) IS THE TARGET VALUE TO FIND
          DIM1_INV = DIM7_LUT(INDX_DIM1_LUT_BOL)
      ENDIF ELSE BEGIN
      ...
      DIM6_LUT_RNG_DIM1_TOL = DIM6_LUT_RNG_DIM1_BOL
      DIM7_LUT_RNG_DIM1_TOL = DIM7_LUT_RNG_DIM1_BOL
    ...
    ENDIF ELSE BEGIN
      ...
      DIM6_LUT_RNG_DIM1_TOL = DIM6_LUT(INDX_DIM1_LUT_TOL)
      DIM7_LUT_RNG_DIM1_TOL = DIM7_LUT(INDX_DIM1_LUT_TOL)
      
      IF KEYWORD_SET(INVERSE_Z) THEN BEGIN
        ; FIND PROPER DIM7 VALUE REGARDING CURRENT DIM1 VALUE BW. DIM1 RANGE (BOL/TOL)
        DIM1_INV= INTERP1D_MULTIY([CUR_DIM1_VAL_BOL, CUR_DIM1_VAL_TOL], [ [DIM7_LUT(INDX_DIM1_LUT_BOL)] , [DIM7_LUT(INDX_DIM1_LUT_TOL)] ], CUR_DIM1_VAL);
      ENDIF ELSE BEGIN
    ...
    DIM6_LUT_RNG_DIM2_BOL = DIM6_LUT_RNG_DIM1_BOL(INDX_DIM2_LUT_BOL)
    DIM7_LUT_RNG_DIM2_BOL = DIM7_LUT_RNG_DIM1_BOL(INDX_DIM2_LUT_BOL)
    ...
    IF DIM2_DOINTERP(INC) EQ 0 THEN BEGIN
      ...
      DIM6_LUT_RNG_DIM2_TOL = DIM6_LUT_RNG_DIM2_BOL
      DIM7_LUT_RNG_DIM2_TOL = DIM7_LUT_RNG_DIM2_BOL
      
    ENDIF ELSE BEGIN
      ; IF LINEAR INTERPOLATION IS REQUIRED > LOOK FOR TOP LIMIT ON REMAINING DIMENSIONS (DIM3/4&5)
      INDX_DIM2_LUT_TOL = WHERE(DIM2_LUT_RNG_DIM1_BOL EQ CUR_DIM2_VAL_TOL)
      ...
      DIM6_LUT_RNG_DIM2_TOL = DIM6_LUT_RNG_DIM1_TOL(INDX_DIM2_LUT_TOL)
      DIM7_LUT_RNG_DIM2_TOL = DIM7_LUT_RNG_DIM1_TOL(INDX_DIM2_LUT_TOL)
    ...
    DIM6_LUT_RNG_DIM3_BOL = DIM6_LUT_RNG_DIM2_BOL(INDX_DIM3_LUT_BOL)
    DIM7_LUT_RNG_DIM3_BOL = DIM7_LUT_RNG_DIM2_BOL(INDX_DIM3_LUT_BOL)
    ...
    IF DIM3_DOINTERP(INC) EQ 0 THEN BEGIN
      ...
      DIM6_LUT_RNG_DIM3_TOL = DIM6_LUT_RNG_DIM3_BOL
    ENDIF ELSE BEGIN
      ...
      DIM6_LUT_RNG_DIM3_TOL = DIM6_LUT_RNG_DIM2_TOL(INDX_DIM3_LUT_TOL)
      DIM7_LUT_RNG_DIM3_TOL = DIM7_LUT_RNG_DIM2_TOL(INDX_DIM3_LUT_TOL)	  
    ...
    ; -- DATA RANGE RESTRICTION ON 4ST DIMENSION (DIM4) --
    ; GET CURRENT INPUT DATA ON 2ND DIMENSION + BOTTOM LIMIT (BOL) + TOP LIMIT (TOL)
    CUR_DIM4_VAL_BOL=DIM4_VAL_BOL(INC)
    CUR_DIM4_VAL_TOL=DIM4_VAL_TOL(INC)
    CUR_DIM4_VAL=DIM4(INC)
    
    ; GET CURRENT INPUT DATA ON 4TH DIMENSION + BOTTOM LIMIT (BOL) + TOP LIMIT (TOL)    
    INDX_DIM4_LUT_BOL = WHERE(DIM4_LUT_RNG_DIM2_BOL EQ CUR_DIM4_VAL_BOL)
    DIM5_LUT_RNG_DIM4_BOL = DIM5_LUT_RNG_DIM3_BOL(INDX_DIM4_LUT_BOL)
    DIM6_LUT_RNG_DIM4_BOL = DIM6_LUT_RNG_DIM3_BOL(INDX_DIM4_LUT_BOL)
    DIM7_LUT_RNG_DIM4_BOL = DIM7_LUT_RNG_DIM3_BOL(INDX_DIM4_LUT_BOL)
    ...
    IF DIM4_DOINTERP(INC) EQ 0 THEN BEGIN
      ...
      DIM6_LUT_RNG_DIM4_TOL = DIM6_LUT_RNG_DIM4_BOL      
      DIM7_LUT_RNG_DIM4_TOL = DIM7_LUT_RNG_DIM4_BOL      
    ENDIF ELSE BEGIN
      INDX_DIM4_LUT_TOL = WHERE(DIM4_LUT_RNG_DIM3_TOL EQ CUR_DIM4_VAL_TOL)
      DIM5_LUT_RNG_DIM4_TOL = DIM5_LUT_RNG_DIM4_TOL(INDX_DIM4_LUT_TOL)
      DIM6_LUT_RNG_DIM4_TOL = DIM6_LUT_RNG_DIM4_TOL(INDX_DIM4_LUT_TOL)
      DIM7_LUT_RNG_DIM4_TOL = DIM7_LUT_RNG_DIM4_TOL(INDX_DIM4_LUT_TOL)	  
    ...
    ; -- DATA RANGE RESTRICTION ON 5TH DIMENSION (DIM5) --
    ; GET CURRENT INPUT DATA ON 2ND DIMENSION + BOTTOM LIMIT (BOL) + TOP LIMIT (TOL)
    CUR_DIM5_VAL_BOL=DIM5_VAL_BOL(INC)
    CUR_DIM5_VAL_TOL=DIM5_VAL_TOL(INC)
    CUR_DIM5_VAL=DIM5(INC)

    ; GET CURRENT INPUT DATA ON 5TH DIMENSION + BOTTOM LIMIT (BOL) + TOP LIMIT (TOL)
    INDX_DIM5_LUT_BOL = WHERE(DIM5_LUT_RNG_DIM3_BOL EQ CUR_DIM5_VAL_BOL)
    DIM6_LUT_RNG_DIM5_BOL = DIM6_LUT_RNG_DIM4_BOL(INDX_DIM5_LUT_BOL)
    DIM7_LUT_RNG_DIM5_BOL = DIM7_LUT_RNG_DIM4_BOL(INDX_DIM5_LUT_BOL)	
    OUT_LUT_RNG_DIM5_BOL = OUT_LUT_RNG_DIM4_BOL(INDX_DIM5_LUT_BOL)
    IF DIM6_DOINTERP(INC) EQ 0 THEN BEGIN
      ; NO INTERPOLATION REQUIRED : DIM4 SAMPLE ON A DIM4 BKPT OR OUT OF DIM4 RANGE
      DIM5_INV = DIM4_INV(INDX_DIM5_LUT_BOL)
      DIM6_LUT_RNG_DIM5_TOL = DIM6_LUT_RNG_DIM5_BOL
	  DIM7_LUT_RNG_DIM5_TOL = DIM7_LUT_RNG_DIM5_BOL
    ENDIF ELSE BEGIN
      INDX_DIM5_LUT_TOL = WHERE(DIM5_LUT_RNG_DIM4_TOL EQ CUR_DIM5_VAL_TOL)
      DIM6_LUT_RNG_DIM5_TOL = DIM6_LUT_RNG_DIM4_TOL(INDX_DIM5_LUT_TOL)
      DIM7_LUT_RNG_DIM5_TOL = DIM7_LUT_RNG_DIM4_TOL(INDX_DIM5_LUT_TOL)
      DIM5_INV= INTERP1D_MULTIY([CUR_DIM5_VAL_BOL, CUR_DIM5_VAL_TOL], [ [DIM4_INV(INDX_DIM5_LUT_BOL)] , [DIM4_INV(INDX_DIM5_LUT_TOL)] ], CUR_DIM5_VAL);
    ENDELSE
    
    ; -- DATA RANGE RESTRICTION ON 6TH DIMENSION (DIM6) -
    ; GET CURRENT INPUT DATA ON 6TH DIMENSION + BOTTOM LIMIT (BOL) + TOP LIMIT (TOL)
    CUR_DIM6_VAL_BOL=DIM6_VAL_BOL(INC)
    CUR_DIM6_VAL_TOL=DIM6_VAL_TOL(INC)
    CUR_DIM6_VAL=DIM6(INC)

    ; GET CURRENT INPUT DATA ON 6TH DIMENSION + BOTTOM LIMIT (BOL) + TOP LIMIT (TOL)
    INDX_DIM6_LUT_BOL = WHERE(DIM6_LUT_RNG_DIM4_BOL EQ CUR_DIM6_VAL_BOL)
    DIM7_LUT_RNG_DIM6_BOL = DIM7_LUT_RNG_DIM5_BOL(INDX_DIM6_LUT_BOL)
    OUT_LUT_RNG_DIM6_BOL = OUT_LUT_RNG_DIM5_BOL(INDX_DIM6_LUT_BOL)
    IF DIM7_DOINTERP(INC) EQ 0 THEN BEGIN
      ; NO INTERPOLATION REQUIRED : DIM5 SAMPLE ON A DIM5 BKPT OR OUT OF DIM5 RANGE
      DIM6_INV = DIM5_INV(INDX_DIM6_LUT_BOL)
      DIM7_LUT_RNG_DIM6_TOL = DIM7_LUT_RNG_DIM6_BOL
    ENDIF ELSE BEGIN
      INDX_DIM6_LUT_TOL = WHERE(DIM6_LUT_RNG_DIM5_TOL EQ CUR_DIM6_VAL_TOL)
      DIM7_LUT_RNG_DIM5_TOL = DIM7_LUT_RNG_DIM4_TOL(INDX_DIM6_LUT_TOL)
      DIM6_INV= INTERP1D_MULTIY([CUR_DIM6_VAL_BOL, CUR_DIM6_VAL_TOL], [ [DIM5_INV(INDX_DIM6_LUT_BOL)] , [DIM5_INV(INDX_DIM6_LUT_TOL)] ], CUR_DIM6_VAL);
    ENDELSE

    ; FOCUS ON REMAINING DATA ON 7TH DIMENSION LIMITED TO 1D 
    ; FILTER OUT NAN VALUES ON X
    CUR_DIM7_VAL=DIM7(INC)
    INDX_XNAN=WHERE(FINITE(DIM6_INV, /NAN),COUNT_NAN,COMPLEMENT=INDX_XVLD)
    IF COUNT_NAN EQ N_ELEMENTS(DIM6_INV) THEN BEGIN
      OUT_VAL(INC)=!VALUES.F_NAN
      CONTINUE ; NEXT INC VALUE IN FOR LOOP
    ENDIF
    DIM6_INV=DIM6_INV(INDX_XVLD);
    
    IF KEYWORD_SET(INVERSE_Z) THEN BEGIN
      DIMOUT_LUT=OUT_LUT_RNG_DIM6_BOL(INDX_XVLD);
      ; LOOK FOR INVERTED VALUE OF DIM6 THROUGH DIMOUT VALUE
      OUT_VAL(INC)=INTERP1D(DIM6_INV,DIMOUT_LUT,CUR_DIM7_VAL);
    ENDIF ELSE BEGIN
      ; LOOK FOR DIMOUT THROUGH DIM7 DATA RANGE @ CUR_DIM6_VAL
      OUT_VAL(INC)=INTERP1D(DIM7_LUT_RNG_DIM6_BOL,DIM6_INV,CUR_DIM7_VAL);
    ENDELSE
