...
; DEFINE THE MAIN WIDGET 
  ...
  DHMI_P3_TLB = WIDGET_BASE(COLUMN=1,TITLE='DIMITRI V2.0: RAYLEIGH CAL SETUP',XSIZE=XSIZE,$
...
; RAYLEIGH CAL PARAMETERS
  ...
  IF WIN_FLAG THEN DHMI_P3_TLB_3_TRID = FSC_FIELD(DHMI_P3_TLB_3,VALUE=BASE_TRC865,TITLE ='MAX RHO_RC AT 865 NM:',OBJECT=FSCP3_TRC865,DECIMAL=3,XSIZE=SML_FSC_X) $  
              ELSE DHMI_P3_TLB_3_TRID = FSC_FIELD(DHMI_P3_TLB_3,VALUE=BASE_TRC865,TITLE ='MAX RHO_RC AT 865 NM:',OBJECT=FSCP3_TRC865,DECIMAL=3,XSIZE=SML_FSC_X)
