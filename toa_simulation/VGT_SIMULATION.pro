...
; BRDF MODEL VALUES - ONLY TESTING ON MERIS CURRENTLY DO TO LIMITED AATSR BINS    
      ...
      IF  TOA_VZA LT MER_UC[2,MER_TEMP_BINS[0]] OR TOA_VZA GT MER_UC[3,MER_TEMP_BINS[0]] OR     $
        ...
        IF KEYWORD_SET(VERBOSE) THEN PRINT, 'BRDF VZA MIN:',MER_UC[2,MER_TEMP_BINS[0]],' MAX:',MER_UC[3,MER_TEMP_BINS[0]],'| VGT VZA:',TOA_VZA
        IF KEYWORD_SET(VERBOSE) THEN PRINT, 'BRDF SZA MIN:',MER_UC[4,MER_TEMP_BINS[0]],' MAX:',MER_UC[5,MER_TEMP_BINS[0]],'| VGT SZA:',TOA_SZA 
        IF KEYWORD_SET(VERBOSE) THEN PRINT, 'BRDF RAA MIN:',MER_UC[6,MER_TEMP_BINS[0]],' MAX:',MER_UC[7,MER_TEMP_BINS[0]],'| VGT RAA:',TOA_RAA  
        ;GOTO,NEXT_VGT_DATE
