...
; DESERT CALIBRATION (HsBRDF Methodology)
  ...
  IF DHMI_P5_INFO.IVERBOSE EQ 1 THEN PRINT,'DHMI_DESERT_ARG->START: RUNNING DESERT CALIBRATION'  
  
  PRINT,'DHMI_DESERT_ARG->START: WARNING !!!!!! ------------------------------ !!!!!'  
  PRINT,'DHMI_DESERT_ARG->START: WARNING !!!!!! CONSOLIDATED OPTION DESACTIVED !!!!!'  
  PRINT,'DHMI_DESERT_ARG->START: WARNING !!!!!! ------------------------------ !!!!!'  
  
;  RES = SIMULATE_TOA_TIME_SERIES(P5_REGION,P5_SENSOR,P5_PROC,P5_YEAR,P5_PHOTON_NB,P5_CPU_NB, /CONSOLIDATED, VERBOSE=DHMI_P5_INFO.IVERBOSE)
  RES = SIMULATE_TOA_TIME_SERIES(P5_REGION,P5_SENSOR,P5_PROC,P5_YEAR,P5_PHOTON_NB,P5_CPU_NB, VERBOSE=DHMI_P5_INFO.IVERBOSE)
  
  IF RES NE 1 THEN BEGIN
   MSG = ['DIMITRI DESERT ARGANS PROCESS :','ERROR DURING DESERT CALIBRATION']
...
; TO PROCESS_5 WIDGET
  ...
  P5_ERR:
  IF DHMI_P5_INFO.IVERBOSE EQ 1 THEN PRINT,'DHMI_DESERT_ARG->START: DESTROYING INFO WIDGET AND RETURNING'
...
; DESTROY THE WIDGET
  ...
  IF DHMI_P5_INFO.IVERBOSE EQ 1 THEN PRINT,'DHMI_DESERT_ARG->EXIT: DESTROYING PROCESS 5 WIDGET'
...
; FIND MAIN DIMITRI FOLDER AND DELIMITER
  ...
  IF KEYWORD_SET(VERBOSE) THEN BEGIN
    PRINT,'DHMI_DESERT_ARG: STARTING PROCESS 5 HMI ROUTINE'
    IVERBOSE=1
...
; DEFINE THE MAIN WIDGET 
  ...
  DHMI_P5_TLB = WIDGET_BASE(COLUMN=1,TITLE=TOOL+': DESERT CALIBRATION SETUP',XSIZE=XSIZE,$
