...
; GET LIST OF ALL SITE NAMES
  ...
  YEAR_SEARCH = STRING(INDGEN(21)+2000,FORMAT='(I4)')
...
; BUILD UP THE WIDGET
  ...
  DHMI_INGEST_TLB     = WIDGET_BASE(COLUMN=1,TITLE='DIMITRI V'+DIMITRI_VERSION+': INGEST L1B',XSIZE=XSIZE,XOFFSET=XLOC,YOFFSET=YLOC)
