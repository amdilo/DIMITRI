...
;*      17 APR 2015 - NCG / MAGELLIUM - REMOVE FILENAME CONSTRUCTION (DIMITRI V4.0)
;*
;* VALIDATION HISTORY:
...
;*      17 APR 2015 - NCG / MAGELLIUM      - LINUX 64BIT UBUNTU IDL 8.0: COMPILATION AND OPERATION SUCCESSFUL (DIMITRI V4.0) 
;*
;**************************************************************************************
;**************************************************************************************

FUNCTION GET_MODISA_QUICKLOOK_LINUX,FILENAME,OUTPUT_QL_FILENAME,RGB=RGB,ROI=ROI,ICOORDS=ICOORDS,QL_QUALITY=QL_QUALITY,VERBOSE=VERBOSE

  FCT_NAME = 'GET_MODISA_QUICKLOOK_LINUX'
...
; OUTPUT QUICKLOOK AS JPEG
  ...
  WRITE_JPEG ,OUTPUT_QL_FILENAME,REVERSE(REVERSE(QL_IMAGE,3),2),TRUE=1,ORDER=ORDER
