...
; IDENTIFIY CURRENT DIRECTORY AND INPUT FOLDER
  ...
  CURRENT_DIR=STRING(STRMID(CURRENT_DIR,0,POS1+16)) ; BAH: SUPOSE THAT DIMITRI FOLDER NAME DOES NOT EXEED 16 CHARACTERS
  ...
  IF P2MP1 EQ -1 THEN BEGIN
     CENTRAL_FOLDER = STRING(STRMID(CURRENT_DIR,0,POS1+POS2)+DL)
  ENDIF ELSE BEGIN  
