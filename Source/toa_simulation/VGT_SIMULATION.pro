...
; FIND USABLE VGT DATA 
  ...
  RES = WHERE(STRCMP(DB_DATA.SITE_NAME,SL_REGION)                  EQ 1 AND $
                ...
                DB_DATA.ROI_PIX_NUM GE PX_THRESH[0])
...
; GET OZONE AND WVAP VALUES FROM VGT, OR USE DEFAULT    
    ...
    IF WVAP LT 0. THEN IF REGION EQ 'DomeC' then WVAP=0.0125 else wvap=2.
