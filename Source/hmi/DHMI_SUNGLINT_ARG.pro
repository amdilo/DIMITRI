...
; GLINT CAL
  ...
  IF DHMI_P4_INFO.IVERBOSE EQ 1 THEN PRINT,'DHMI_SUNGLINT_ARG->START: RUNNING GLINT CALIBRATION'  

   RES = GLINT_CALIBRATION(P4_REGION,P4_SENSOR,P4_PROC,P4_YEAR,P4_CSPERCENT,P4_ROIPERCENT,$
                          P4_WINDMAX,P4_CONEMAX,P4_BREF,P4_CALREF,P4_CHL,P4_TAU865,P4_AER, PIX=PIX, CLIM=CLIM, VERBOSE=DHMI_P4_INFO.IVERBOSE)
  
  IF RES NE 1 THEN BEGIN
   MSG = ['SUNGLINT_ARG:','ERROR DURING GLINT CAL']
...
; TO PROCESS_4 WIDGET
  ...
  P4_ERR:
  IF DHMI_P4_INFO.IVERBOSE EQ 1 THEN PRINT,'DHMI_SUNGLINT_ARG->START: DESTROYING INFO WIDGET AND RETURNING'
...
; DESTROY THE WIDGET
  ...
  IF DHMI_P4_INFO.IVERBOSE EQ 1 THEN PRINT,'DHMI_SUNGLINT_ARG->EXIT: DESTROYING PROCESS 4 WIDGET'
...
; FIND MAIN DIMITRI FOLDER AND DELIMITER
  ...
  IF KEYWORD_SET(VERBOSE) THEN BEGIN
    PRINT,'DHMI_SUNGLINT_ARG: STARTING PROCESS 4 HMI ROUTINE'
    IVERBOSE=1
...
; DEFINE THE MAIN WIDGET 
  ...
  DHMI_P4_TLB = WIDGET_BASE(COLUMN=1,TITLE=TOOL+': GLINT CAL SETUP',XSIZE=XSIZE,$
