...
;*      12 JUN 2015 - NCG / MAGELLIUM - REPLACE SENSOR_BAND_INFO FUNCTION BY GET_SENSOR_BAND_INFO 
;*                                (BASED DIMITRI_Band_Configuration.csv FILE)
;*
;* VALIDATION HISTORY:
...
; GET NUMBER OF BANDS IN REF SENSOR
  ...
  SENSOR_INFO = GET_SENSOR_BAND_INFO(REF_SENSOR, VERBOSE=VERBOSE)
