...
FUNCTION CLOUD_MODULE_LCCA, LCCA_REF, MODISA=MODISA, CS_CLASSIF_MATRIX=CS_CLASSIF_MATRIX, VERBOSE=VERBOSE
...
; DEFINE ARRAY TO HOLD PIXEL CLASSIFICATION
  ...
  PIXEL_CLASSIFICATION = MAKE_ARRAY(NB_PIXELS,/INTEGER,VALUE=NOSELECT_ID)
  P2CLOUDTYPE = INTARR(NB_PIXELS)

;-----------------------
; SET OUTPUT STRUCTURE
  TEMP_DIMS     = SIZE(LCCA_REF,/DIMENSIONS)
  NBCAN=TEMP_DIMS[1]
...
; UPDATE OUTPUT STRUCTURE 
  CS_CLASSIF_MATRIX[*,1]=PIXEL_CLASSIFICATION
