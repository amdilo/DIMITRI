...
; CEOS IVOS SADE INPUT FILES
  ...
  IF KEYWORD_SET(VGT_SADE) THEN BEGIN
    ...
    FOR ITT = 0l,N_ELEMENTS(SENSOR_TOA_REF[0,*])-1 DO BEGIN
      RES = WHERE(ABS(GD_VGT_DATA[0,*]-SENSOR_TOA_REF[0,ITT]) LT 0.000001 AND $
                  ABS(GD_VGT_DATA[1,*]-SENSOR_TOA_REF[1,ITT]) LT 0.001,COUNT)
      IF COUNT EQ 0 THEN SENSOR_TOA_REF[0,ITT]=-999. ELSE SENSOR_TOA_REF[5:5+12,ITT] = GD_VGT_DATA[5:5+12,RES[0]]
    ENDFOR
