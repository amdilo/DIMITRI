...
;*
;* NAME:
;*      GET_NCDF_CALIB_STRUCT       
;* 
;* PURPOSE:
;*      GET THE STRUCTURE WHICH CORRESPONDS TO THE OUTPUT NCDF FILE OF THE SUNGLINT, 
;*      RAYLEIGH OR DESERT SENSOR TO SIMULATION COMPARISON PROCESSES 
;* 
;* CALLING SEQUENCE:
;*      RES = GET_NCDF_CALIB_STRUCT(INGEST_REGION,INGEST_SENSOR,INGEST_PROC_VER)      
;* 
;* INPUTS:
...
;*
;* OUTPUTS:
;*      STRUCTURE ASSOCIATED TO THE NCDF OUTPUT FILE
;*
;* COMMON BLOCKS:
;*      NONE
;*
...
;**************************************************************************************
;**************************************************************************************
FUNCTION GET_NCDF_CALIB_STRUCT, CALIB_PIXEL_NUMBER, ROI_PIXEL_NUMBER, VIEWDIR_NUMBER, BAND_NUMBER, VERBOSE=VERBOSE

  IF KEYWORD_SET(VERBOSE) THEN PRINT, 'GET_NCDF_CALIB_STRUCT: START'
  ...
  VARIABLES = { $ 
                  ...
                  REFL_BAND_IDS           : MAKE_ARRAY(BAND_NUMBER, /INTEGER, VALUE=MISSING_VALUE), $
                  ...
                  CALIB_VALID_INDEX       : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  WIND_SPEED_ESTIM        : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  AEROSOL_OT_ESTIM        : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  BAND_GAZ_TRANS          : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, BAND_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  BAND_RHO_SIM            : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, BAND_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  BAND_RHO_SIM_UNCERT     : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, BAND_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  BAND_REF_TO_SIM_RATIO   : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, BAND_NUMBER, /FLOAT, VALUE=MISSING_VALUE), $
                  BAND_VALID_INDEX        : MAKE_ARRAY(CALIB_PIXEL_NUMBER, VIEWDIR_NUMBER, BAND_NUMBER, /FLOAT, VALUE=MISSING_VALUE) }
  ...
  NCDF_CALIB_STRUCT = { GLOBAL_ATT : GLOBAL_ATT, DIMENSIONS : DIMENSIONS, VARIABLES : VARIABLES, VARIABLES_ATT : VARIABLES_ATT }

  
  IF KEYWORD_SET(VERBOSE) THEN PRINT, 'GET_NCDF_CALIB_STRUCT: END'
  
  RETURN, NCDF_CALIB_STRUCT
