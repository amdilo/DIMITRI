...
; SORT OUT CONFIGURATIONS
  ...
  ATS_CFIG = STRMID(ATS_CFIG,TMP,STRLEN(ATS_CFIG)-TMP)
...
; RUN BRDF COMPUTATIONS AND CHECK RETURNED VALUES
  ...
  MRES = DIMITRI_INTERFACE_ROUJEAN(MFOLDER,SITE,DHMI_P2_INFO.MER_SENSOR,MER_CFIG,$
          BRDF_BIN=BIN_PERIOD,NO_PLOTS=BPLOT,VERBOSE=DHMI_P2_INFO.IVERBOSE)
...
; RUN PROCESS 2 AND CHECK OUTPUT
  ...
  VRES = VGT_SIMULATION(SITE,MFOLDER,MER_CFIG,AFOLDER,ATS_CFIG,VGT_CFIG,$
                          CSPERCENT,ROIPERCENT,BIN_PERIOD,VERBOSE=DHMI_P2_INFO.IVERBOSE)
...
; ADD WIDGET SECTIONS FOR SECOND SECTION
  ...
  DHMI_P2_TLB_4       = WIDGET_BASE(DHMI_P2_TLB,ROW=1,/ALIGN_RIGHT)
  DHMI_P2_TLB_4_BTN   = WIDGET_BUTTON(DHMI_P2_TLB_4,VALUE='Start',XSIZE=SML_BTN,EVENT_PRO='DHMI_PROCESS_2_START')
  DHMI_P2_TLB_4_BTN   = WIDGET_BUTTON(DHMI_P2_TLB_4,VALUE='Exit',XSIZE=SML_BTN, EVENT_PRO='DHMI_PROCESS_2_EXIT')
