...
; FIND INDEX OF RECORDS WITHIN THIS SITE
  ...
  SITE_INDEX = WHERE(DHMI_DB_DATA.SITE_NAME EQ VAL_SITE,COUNT)
...
; FOR EACH YEAR 
    ...
    RES = WHERE(DHMI_DB_DATA.SITE_NAME EQ VAL_SITE   AND                    $
...
; DEFINE THE BASE WIDGET
  ...
  PLOT_TITLE   = STRING('DIMITRI 3.0 ACQUISITION STATS: '+VAL_SITE)
...
; CREATE THE BLANK PLOT AND MOVE THE LEGEND
  ...
  STATS_LEGENDMODEL->TRANSLATE, .99, .75, 0 
