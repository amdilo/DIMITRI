...
;*
;* PURPOSE:
;*      FUNCTION TO PERFORM OPTIMIZED 5D INTERPOLATION THROUGH A 5-D LOOK-UP TABLE (DIRECT DATA RANGE RESTRICTION METHOD)
;*
;* CALLING SEQUENCE:
;*      OUT_VAL = INTERP5D(OUT_LUT, $
;*                         DIM1, DIM2, DIM3, DIM4, DIM5, $
;*                         DIM1_BKPT_VALUES, DIM2_BKPT_VALUES, DIM3_BKPT_VALUES, DIM4_BKPT_VALUES, DIM5_BKPT_VALUES, $
;*                         INVERSE_Z=INVERSE_Z) 
;*
;* INPUTS:
...
FUNCTION INTERP5D, OUT_LUT, $
                    DIM1, DIM2, DIM3, DIM4, DIM5, $
                    DIM1_BKPT_VALUES, DIM2_BKPT_VALUES, DIM3_BKPT_VALUES, DIM4_BKPT_VALUES, DIM5_BKPT_VALUES, INVERSE_Z=INVERSE_Z
  ...
  LUT = REFORM(OUT_LUT, NB_DIM5_BKPT, NB_DIM4_BKPT, NB_DIM3_BKPT, NB_DIM2_BKPT, NB_DIM1_BKPT)
  ...
  IF NOT KEYWORD_SET(INVERSE_Z) THEN BEGIN
    ...
    IDX_VALID = WHERE( DIM1 GE DIM1_BKPT_VALUES[0] AND DIM1 LE DIM1_BKPT_VALUES[NB_DIM1_BKPT-1] $
                       ...
                       AND DIM5 GE DIM5_BKPT_VALUES[0] AND DIM5 LE DIM5_BKPT_VALUES[NB_DIM5_BKPT-1] , NB_VALID, NCOMPLEMENT=NB_INVALID )
    
    IF NB_INVALID NE 0 THEN BEGIN
      PRINT, 'INTERP5D_OPTI - WARNING : POINTS OUTSIDE THE LIMITS OF THE LUT TABLES, NO INTERPOLATION COMPUTED, POINTS SETTED TO INVALID'
    ENDIF
    ...
    FOR I=0L,NB_VALID-1 DO BEGIN
       ...
       OUT_VAL(INC) = NINTERPOLATE(LUT,[DIM5_IDX,DIM4_IDX,DIM3_IDX,DIM2_IDX,DIM1_IDX])
  ...
  ENDIF ELSE BEGIN
    ...
    ; LOOP OVER SAMPLE
    DIMOUT_VALUES = FLTARR(NB_DIM5_BKPT)
    FOR I=0L,NB_VALID-1 DO BEGIN
       ...
       ; LOOP ON DIM5 BKPT VALUES FOR ESTIMATION OF LUT OUTPUT VALUES
       FOR BKPT=0, NB_DIM5_BKPT-1 DO BEGIN         
         DIMOUT_VALUES[BKPT] = NINTERPOLATE(LUT,[BKPT,DIM4_IDX,DIM3_IDX,DIM2_IDX,DIM1_IDX])
       ENDFOR
       
       ; 1D INTERPOLATION ACROSS DIM5 BKPT VALUES FOR ESTIMATION OF DIM5 SEARCHED VALUE   
       OUT_VAL(INC) = INTERP1D(DIMOUT_VALUES, DIM5_BKPT_VALUES, DIM5(INC))
