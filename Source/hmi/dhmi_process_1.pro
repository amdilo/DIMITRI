...
;*      21 JAN 2015 - B ALHAMMOUD    - UPDATED TO DIMITRI-3.1.1 PREVIOUSLY CALLED V3.1a
...
; DEFINE THE MAIN WIDGET 
  ...
  DHMI_P1_TLB = WIDGET_BASE(COLUMN=1,TITLE='DIMITRI V'+DIMITRI_VERSION+': SENSOR RECAL SETUP',XSIZE=XSIZE,$
