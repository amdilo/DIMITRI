...
;*
;* NAME:
;*      DIMITRI_INTERFACE_RAYLEIGH_ARG
;* 
;* PURPOSE:
...
;* 
;* CALLING SEQUENCE:
;*      RES = DIMITRI_INTERFACE_RAYLEIGH_ARG(SITE_NAME,SENSOR,PROC_VERSION, $
...
FUNCTION DIMITRI_INTERFACE_RAYLEIGH_ARG, SITE_NAME, SENSOR, PROC_VERSION,$
  ...
  FCT_NAME         = 'DIMITRI_INTERFACE_RAYLEIGH_ARG'
