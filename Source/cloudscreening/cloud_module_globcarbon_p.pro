...
;* 
;* CALLING SEQUENCE:
;*      RES = CLOUD_MODULE_GLOBCARBON_P(SITE_TYPE,GCARBON_REF)    
;* 
;* INPUTS:
...
FUNCTION CLOUD_MODULE_GLOBCARBON_P,SITE_TYPE,GCARBON_REF,CS_ANG,CS_CLASSIF_MATRIX=CS_CLASSIF_MATRIX,VERBOSE=VERBOSE
