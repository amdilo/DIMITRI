...
; CALL INGEST INTERFACE
  ...
  CASE ACTION OF
    'PROCESS':  RES = DIMITRI_INTERFACE_INGEST(INGEST_REGION,INGEST_SENSOR,INGEST_PROC_VER,$
                                              COLOUR_TABLE=COLOUR_TABLE,PLOT_XSIZE=PLOT_XSIZE,PLOT_YSIZE=PLOT_YSIZE,verbose=DHMI_INGEST_INFO.IVERBOSE)

    'ALL':      RES = DIMITRI_INTERFACE_INGEST(INGEST_REGION,INGEST_SENSOR,INGEST_PROC_VER,/ALL,$
                                              COLOUR_TABLE=COLOUR_TABLE,PLOT_XSIZE=PLOT_XSIZE,PLOT_YSIZE=PLOT_YSIZE,verbose=DHMI_INGEST_INFO.IVERBOSE)
  ENDCASE
...
; BUILD UP THE WIDGET
  ...
  DHMI_INGEST_TLB_PAR = WIDGET_BASE(DHMI_INGEST_TLB_FRM, ROW=4,/ALIGN_CENTER)
