...
; SET UP PARAMETERS
  ...
  OFOLDER           = FILEPATH('',root_dir = MAIN_DIR, subdir=['Output','CK_TEST_M1']) ; FULL PATH OF THE OUTPUT FOLDER TO BE CREATED
  ...
  SENSOR2S          = ['AATSR','MODISA','PARASOL']                  ; CALIBRATION SENSORs - insert as many as you wish
  PROC_VER2S        = ['2nd_Reprocessing','Collection_5','Calibration_1'] ; CALIBRATION SENSOR PROCESSING VERSIONS
