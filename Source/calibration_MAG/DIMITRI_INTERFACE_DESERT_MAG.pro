...
;*
;* NAME:
;*      DIMITRI_INTERFACE_DESERT_MAG       
;* 
;* PURPOSE:
;*      MAIN DESERT SENSOR TO SIMULATION COMPARISON ROUTINE 
;* 
;* CALLING SEQUENCE:
;*      RES = DIMITRI_INTERFACE_DESERT_MAG(SITE_NAME,SENSOR,PROC_VERSION)      
;* 
;* INPUTS:
...
FUNCTION DIMITRI_INTERFACE_DESERT_MAG,SITE_NAME,SENSOR,PROC_VERSION,ALL=ALL,YEAR=YEAR,VERBOSE=VERBOSE

  DEBUG_MODE = 0      ; SET TO 1 IF WANT TO DEBUG THIS PROCEDURE
  
  FCT_NAME = 'DIMITRI_INTERFACE_DESERT_MAG'
