...
;   CONVOLVE TO VGT RSR 
    ...
    ; if band one is negative then somethings gone wrong - insert 0 values
    	if SIMU_VGT[IDX,NUM_NON_REF] lt 0.0 then SIMU_VGT[IDX,NUM_NON_REF:NUM_NON_REF+NB_BANDS_VGT-1]=0.
