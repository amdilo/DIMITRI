...
; ADD DATA TO NETCDF OUTPUT STRUCTURE
  ...
  NCDF_OUT = GET_DIMITRI_EXTRACT_NCDF_DATA_STRUCTURE(NB_FILES,NB_ANDS,NB_DIRECTIONS)
...
; STORE DATE IN NETCDF STRUCTURE
    ...
    NCDF_OUT.VAR_PTIME[IN_FNAME]  = STRMID(L1B_HEADER.DATE,0,8)+' '+STRMID(L1B_HEADER.DATE,8,2)+':'+STRMID(L1B_HEADER.DATE,10,2)+':'+STRMID(L1B_HEADER.DATE,12,2)
